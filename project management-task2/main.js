...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const tasks = [
        { taskName: 'Task 1', assignedTo: 'Sivaranjani', dueDate: '2023-11-01', description: 'Description for Task 1' },
    { taskName: 'Task 2', assignedTo: 'Shanmugapriya', dueDate: '2023-10-22', description: 'Description for Task 2' },
    // Add more tasks here
